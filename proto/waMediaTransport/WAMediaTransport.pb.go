...
const file_waMediaTransport_WAMediaTransport_proto_rawDesc = "" +
	...
	"\bIntegral\x12@\n" +
	"\ttransport\x18\x01 \x01(\v2\".WAMediaTransport.WAMediaTransportR\ttransport\"\xf1\x04\n" +
	"\x0eVideoTransport\x12E\n" +
	"\bintegral\x18\x01 \x01(\v2).WAMediaTransport.VideoTransport.IntegralR\bintegral\x12H\n" +
	"\tancillary\x18\x02 \x01(\v2*.WAMediaTransport.VideoTransport.AncillaryR\tancillary\x1a\xff\x02\n" +
	"\tAncillary\x12\x18\n" +
	...
	"\x12accessibilityLabel\x18\b \x01(\tR\x12accessibilityLabel\"-\n" +
	"\vAttribution\x12\b\n" +
	"\x04NONE\x10\x00\x12\t\n" +
	...
	"\acontactB8Z6github.com/timtyndale/whatsmeow/proto/waMediaTransport"
